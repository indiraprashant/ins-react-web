    ...
    return (
        <Fragment>
            ...
            <div className="container custom_spacing text-center">
                <h3 className="subheadingM">Admission Procedure Grade IV Afternoon Shift (A/Y-2022-23)</h3>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td rowspan="4">Step 1</td>
                                                ...
                                                <td>Saturday, 26th March 2022</td>
                                                <td>Admission form Open</td>
                                        ...
                                        <tr>
                                           <td>Wednesday, 30th March 2022</td>
                                           <td rowspan="2">Admission <br/>form Closed</td>
                                        ...
                                        <tr>
                                            <td>Step 2</td>
                                            <td colspan="2"><b>Uploading of Documents</b></td>
                                            <td class="text-left">Parents will receive an Email/ SMS to upload the documents online along with the details of School Visit for Submission of documents, Payment of fees and confirmation of Admission</td>
                                        </tr>
            ...
            <div className="container text-center">
                ...
                <h3 className="subheadingM">Fees & Payment</h3>
                    <p><b>Fee Structure for Grade I-X for A.Y (2022-23)</b></p>
                    <div className="table-responsive">
                        <table className="table table-bordered">
                            <tbody>
                                <tr>
